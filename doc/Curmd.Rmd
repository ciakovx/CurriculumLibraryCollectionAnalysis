...
source("C:/Users/iakovakis/Documents/Projects/acquisitions/colclean.R")
source("C:/Users/iakovakis/Documents/Projects/acquisitions/checkouts_graph.R")
source("C:/Users/iakovakis/Documents/Projects/acquisitions/publication.R")
source("C:/Users/iakovakis/Documents/Projects/acquisitions/fullLC.R")
library(xtable)

setwd("C:/Users/iakovakis/Documents/Purchasing/Cur")
cur <- read.csv(file = paste0(getwd(), "/CurAll.txt"), sep = "^", stringsAsFactors = F, na.strings = c("    ",""))
...
cls.sums <- aggregate(cur.lc$tot.chkout, by = list(cur.lc$cls), sum)
...
names(df2) <- c("Checkouts", "Proportion of Items: Curriculum", "Proportion of Items: General")
```
